...
class ChangelogPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.changelog_entries = [
            {"version": "1.1.1", "date": "September, 23, 2026", "features": ["Supports dark mode for UIMode, welcome screen and setup wizard", "Starting to implement myRatings using flutter + dart for cross platform compatibility."]},
...
class ModulePage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.modules = [
            {"name": "main.dart", "description": "First Implementation of LDSR", "percentage": 10},
            ...
            {"name": "setup.py", "description": "Welcome Page\nAdd Dictionary besides git icon", "percentage": 95},
