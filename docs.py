...
class ChangelogPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.changelog_entries = [
            {"version": "1.0.37", "date": "July, 17, 2026", "features": ["App usage - Shows how much time you use the app", "Fix combo selector not affected by dark mode", "Fix how to use not affected by dark mode", "Add zoom effect on full definition viewer that will enlarge text size using ctrl + mouse scroll wheel/+/-"]},
